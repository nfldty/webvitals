...
const Overview = () => {
  ...
  const effectiveUserId = userId || "1"; // TODO: delete this if need be to just use the userId and not just force to admin user on default load.
  ...
  useEffect(() => {
    // Always fetch using effectiveUserId
